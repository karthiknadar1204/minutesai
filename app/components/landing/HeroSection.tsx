                            ...
                            {isSignedIn ? (
                                ...
                                <>
                                    ...
                                    <SignUpButton mode="modal">
                                        <Button className="bg-[#3498db] hover:bg-[#2980b9] cursor-pointer">
                                            Get Started
                                        </Button>
                                    </SignUpButton>
                                </>
            ...
            <section className="py-20 px-4 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="group relative mx-auto flex w-fit items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#3b82f61f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#3b82f63f] mb-8">
                        ...
                        />
                        <Sparkles className="w-4 h-4 mr-2 text-[#3498db]" />
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                        ...
                        <span className="bg-gradient-to-r from-[#3498db] via-[#2980b9] to-[#1f5f8b] bg-clip-text text-transparent">AI Magic</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                        {isSignedIn ? (
                            ...
                            <SignUpButton mode="modal">
                                <Button size="lg" className="bg-[#3498db] hover:bg-[#2980b9] px-8 py-4 group cursor-pointer">
